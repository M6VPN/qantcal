...
profiles()
{
	static const QVector<PropagationProfile> data = {
		make_profile(QStringLiteral("2200m Amateur"), { QStringLiteral("groundwave"), QStringLiteral("weak-signal LF") }, QStringLiteral("Day/night effects are site and path dependent."), QStringLiteral("Noise-limited LF amateur paths with very small antennas and low permitted radiated power."), QStringLiteral("High atmospheric and man-made noise tendency."), QStringLiteral("Practical transmit antennas are electrically short and ground/counterpoise-sensitive; receive antennas can be much smaller."), QStringLiteral("high variability")),
		make_profile(QStringLiteral("LW Broadcast"), { QStringLiteral("groundwave"), QStringLiteral("night skywave") }, QStringLiteral("Groundwave is important; night effects can change reception."), QStringLiteral("Region-dependent longwave broadcast listening."), QStringLiteral("High noise tendency."), QStringLiteral("Receive loops, active probes, ferrite antennas, and long wires are practical."), QStringLiteral("medium/high variability")),
		make_profile(QStringLiteral("1750m LowFER / experimental reference"), { QStringLiteral("groundwave"), QStringLiteral("experimental LF") }, QStringLiteral("Highly site and rules dependent."), QStringLiteral("Experimental/reference LF listening and lawful experimental work only."), QStringLiteral("High noise tendency."), QStringLiteral("Electrically short antennas and receive probes are expected."), QStringLiteral("high variability")),
		make_profile(QStringLiteral("630m Amateur"), { QStringLiteral("groundwave"), QStringLiteral("night skywave") }, QStringLiteral("Groundwave plus possible night skywave depending on path and season."), QStringLiteral("MF amateur operation where authorised, usually using electrically short antennas."), QStringLiteral("High local noise and ground loss tendency."), QStringLiteral("Loaded verticals, inverted-L antennas, and T/top-loaded verticals are common starting points."), QStringLiteral("high variability")),
		make_profile(QStringLiteral("MW Broadcast Region 1/3"), { QStringLiteral("groundwave"), QStringLiteral("night skywave") }, QStringLiteral("Groundwave by day; night skywave and interference can be strong."), QStringLiteral("Medium-wave broadcast listening reference."), QStringLiteral("High interference and local noise tendency."), QStringLiteral("Ferrite rods, receive loops, active probes, and long wires are practical."), QStringLiteral("medium/high variability")),
		make_profile(QStringLiteral("MW Broadcast Americas"), { QStringLiteral("groundwave"), QStringLiteral("night skywave") }, QStringLiteral("Groundwave by day; night skywave and interference can be strong."), QStringLiteral("Medium-wave broadcast listening reference."), QStringLiteral("High interference and local noise tendency."), QStringLiteral("Ferrite rods, receive loops, active probes, and long wires are practical."), QStringLiteral("medium/high variability")),
